...
const GenerateButton = ({ isOpen, onClick, detectedMood, MOOD_THEMES, DEFAULT_ACCENT }) => {
  const getAccentColor = () => {
    return detectedMood && MOOD_THEMES[detectedMood] 
      ? MOOD_THEMES[detectedMood].accent 
      : DEFAULT_ACCENT;
  };

  const accentColor = getAccentColor();
  const accentHue = accentColor === DEFAULT_ACCENT ? '191deg' : '0deg';

  return (
    <StyledWrapper $accentHue={accentHue} $accentColor={accentColor}>
...
const StyledWrapper = styled.div`
  ...
  .btn {
    ...
    --transition: 0.4s;
    --button-color: #0a0e27;
    --highlight-color-hue: ${props => props.$accentHue};
